...
""" ~~~~~~~~~    basic setting ~~~~~~~~~~~~"""
parser.add_argument('--mode', type=str, default='train', help='train or test')  #test, train
...
parser.add_argument('--max_epochs', type=int, default=200, help='maximum epoch number to train')  #6000
...
if __name__ == "__main__":
    ...
    #HOME = os.path.expanduser("~/scratch/swd9tc/TLRN-main/TLRN-main") 
    HOME = '/scratch/swd9tc/TLRN_MSA' #'/scratch/swd9tc/TLRN-main/TLRN-main'
    args.HOME = HOME
    ...
    if args.mode =="train":
        ...
        #start to test
        save_mode_path_TLRN =  "models/registration_TLRL.pth"   #"./models/registration_TLRN.pth"
